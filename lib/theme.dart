...
TextStyle titleRequirmentTextStyle = GoogleFonts.poppins(
    color: Color(0xff272C2F), fontSize: 14, fontWeight: FontWeight.w500);

TextStyle requirmentTextStyle = GoogleFonts.poppins(
    color: Color(0xff272C2F), fontSize: 14, fontWeight: FontWeight.w300);

TextStyle messageBtnTextStyle = GoogleFonts.poppins(
